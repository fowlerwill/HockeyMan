...
function my_pmprorh_init()
{
  ...
  //define the fields
  $fields = array();
  $fields[] = new PMProRH_Field("first_name", "text", array("size"=>30, "label"=>"First Name", "class"=>"first_name", "profile"=>false, "required"=>true));
  $fields[] = new PMProRH_Field("last_name", "text", array("size"=>30, "label"=>"Last Name", "class"=>"last_name", "profile"=>false, "required"=>true));
  $fields[] = new PMProRH_Field("phone", "text", array("size"=>30, "label"=>"Phone Number", "class"=>"phone", "profile"=>false, "required"=>true));
